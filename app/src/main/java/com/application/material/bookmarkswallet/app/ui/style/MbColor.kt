...
object MbColor {
    ...
    val LemonYellowTertiary = Color(0xFFFFF6AF)
    ...
    val LightGreenRubin = Color(0xFFCEF6DE)
    val LightGreenCobalt = Color(0xFFC4133D)
    val RedVermilionLight = Color(0xFFFFECEC)
    ...
    val GrayBlueDarkNight: Color = Color(0xFF080D1C)//181C21)
    val GrayBlueAlternativeDark: Color = Color(0xFF1C243C)//253262)
